...
case $TASK in
    test_as_client)
        export RUST_LOG="traffic_lib=info,test_as_client=info,e2d2=debug,netfcts=info", RUST_BACKTRACE=1
        ...
        ;;
    test_as_server)
        export RUST_LOG="traffic_lib=debug,test_as_server=debug,e2d2=debug,netfcts=info", RUST_BACKTRACE=1
